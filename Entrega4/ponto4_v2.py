...
circles = cv2.HoughCircles(blured,cv2.HOUGH_GRADIENT,1,img.shape[0]/64,param1=350,param2=26,minRadius=25,maxRadius=45)  # image, dp, minDistance, minRadious and maxRadious
